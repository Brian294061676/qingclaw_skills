...
| 用户输入 | Agent 输出 |
|---------|-----------|
| "调研一下竞品X" | 竞品档案：产品矩阵/定价/目标客群/近期动作 + 核心差异对比表 |
| "我们和竞品的差异在哪？" | 差异分析矩阵：功能/价格/服务/生态四维对比 + 优劣势结论 |
| "这个市场还有什么机会？" | 机会识别：未被满足需求 + 细分空白点 + 进入建议 |
...
```
汇总竞品X最近一个季度的产品发布、价格调整和市场动作，输出影响评估。
```

### 指令3：用户需求洞察

```
基于这批调研问卷，提炼目标用户的核心需求排序和未满足点。
```
